...
export const ServiceTerms = ({ open, onDismiss }) => {
  return (
    ...
    >
      ...
      <p>
        <br>
        서비스 제공자(RIDEUS 운영자)는 RIDEUS라는 유튜브 비디오 플랫폼을 기반으로 한 소셜 SNS 서비스를 운영하고 있습니다. 
        <br>
        RIDEUS의 기본 서비스는 무료이며 프리미엄 고급 기능에 대한 유료 업그레이드를 제공합니다. 
        <br>
        RIDEUS 서비스는 RIDEUS 대화방에서 일어나는 일에 대해 최대한 많은 통제와 소유권을 제공하도록 설계되었습니다. 
        <br>
        ...
        <br>
        <br>
        본 이용 약관을 위반한다고 생각되는 RIDEUS 방을 발견하면 <a href="mailto:mingu4969@naver.com?subject=튜플리 문의드립니다.">[저희에게 연락해 주십시오.]</a>
      </p> --> */}
        <Box style={{ fontSize: "12px" }}>
          <strong style={{ fontSize: "20px" }}>요 약</strong>
          <Box>
            <StyledText
              text="서비스 제공자(RIDEUS 운영자)는 RIDEUS라는 실시간 자전거 주행 플랫폼
              서비스를 운영하고 있습니다. RIDEUS의 기본 서비스는 무료입니다. 
              RIDEUS 서비스는 RIDEUS 그룹주행에서 일어나는 일에 대해 최대한 많은 통제와 소유권을 제공하도록 설계되었습니다.
              그러나 게시한 내용에 대해서는 게시자가 책임을 져야 합니다. 특히
              스팸, 바이러스 또는 심각한 폭력 위협과 같은 금지 품목이 방에
              나타나지 않도록 하셔야 합니다."
            />
            <br />본 이용 약관을 위반한다고 생각되는 RIDEUS 이용자를 발견하면{" "}
            <a href="mailto:zazachucky@naver.com?subject=라이드어스 문의드립니다.">
              [저희에게 연락해 주십시오.]
            </a>
          </Box>
        </Box>
        ...
        <Box style={{ fontSize: "12px" }}>
          ...
          <Box>
            <StyledText
              text="제1조 (목적) 이 약관은 [(주) 라이드어스](이하 “서비스 제공자”라
              ...
              RIDEUS 웹을 통해 이용자에게 제공하는 서비스를 말합니다. 나.
              ...
              관련 자료 및 정보 등을 말합니다. 라. “RIDEUS 웹”은 서비스 제공자가
          ...
          <div>
            <StyledText
              ...
              내용은 다음 각 호와 같습니다. 가. RIDEUS의 작품 경매 기능 나.
              RIDEUS의 작품 추천 기능 다. RIDEUS의 작품 취향 분석 라. RIDEUS의
              이용자 취향 및 작품 태그 기능 마. RIDEUS의 화상 경매 및 채팅 기능
              ...
              변경하는 경우, 변경일로부터 적어도 30일 이전까지 RIDEUS 웹 또는
          ...
          제1조 (개정일) 이 약관은 2022년 9월 20일부터 시행합니다.
        </Box>
      </div>
    </BottomSheet>
  );
