    ...
    >
      ...
      >
        <StyledText
          size="16px"
          weight="700"
          text=" &lt; (주) 라이드어스 &gt;('www.Beedly.com'이하 'Beedly')은(는)
        ...
        제1조(개인정보의 처리 목적)
        <br />
        &lt; (주) 라이드어스 &gt;('www. Rideus.com'이하 'Rideus')은(는) 다음의
        ...
        <br />
        ① &lt; (주) 라이드어스 &gt;은(는) 법령에 따른 개인정보 보유·이용기간
        ...
        <br />
        ① 정보주체는 (주) 라이드어스에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        <br />
        ② 제1항에 따른 권리 행사는(주) 라이드어스에 대해 「개인정보 보호법」
        시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실
        수 있으며 (주) 라이드어스은(는) 이에 대해 지체 없이 조치하겠습니다.
        <br />
        ...
        <br />
        ⑥ (주) 라이드어스은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의
        ...
        제7조(개인정보의 파기)
        <br />
        ① &lt; (주) 라이드어스 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적
        ...
        <br />
        1. 파기절차 &lt; (주) 라이드어스 &gt; 은(는) 파기 사유가 발생한
        개인정보를 선정하고, &lt; (주) 라이드어스 &gt; 의 개인정보 보호책임자의
        승인을 받아 개인정보를 파기합니다.
        <br />
        2. 파기방법
        <br />
        ...
        제8조(개인정보의 안전성 확보 조치)
        <br />
        &lt; (주) 라이드어스 &gt;은(는) 개인정보의 안전성 확보를 위해 다음과
        같은 조치를 취하고 있습니다.
        <br />
        1. 해킹 등에 대비한 기술적 대책 &lt; (주) 라이드어스 &gt; ('Beedly')은
        ...
        <br />① (주) 라이드어스 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
