...
import com.ssafy.rideus.dto.course.common.RecommendationCourseTagDto;
...
//        System.out.println(recommendationCourseDtos);
	...
	// 코스에 대한 태그들 정리
    public Map<String, List<RecommendationCourseTagDto>> getAllCourseTagsMap(List<String> courseIds) {
        ...
        Map<String, List<RecommendationCourseTagDto>> allCourseTagsMap = new HashMap<String, List<RecommendationCourseTagDto>>();
        for(CourseReviewTagTop5DtoInterface courseTags : allCourseTags) {
        	...
        	if(allCourseTagsMap.containsKey(courseId)) {
        		List<RecommendationCourseTagDto> tagList = allCourseTagsMap.get(courseId);
        		tagList.add(RecommendationCourseTagDto.from(courseTags.getTagId(), courseTags.getTagName()));
        		allCourseTagsMap.replace(courseId, tagList);
        	} else {
        		List<RecommendationCourseTagDto> tagList = new ArrayList<RecommendationCourseTagDto>();
        		tagList.add(RecommendationCourseTagDto.from(courseTags.getTagId(), courseTags.getTagName()));
    ...
    public List<RecommendationCourseDto> getAllCourses(Long memberId) {
    	...
    	// 코스에 대한 태그들 
    	Map<String, List<RecommendationCourseTagDto>> allCourseTagsMap = getAllCourseTagsMap(new ArrayList<String>());
	...
	public List<RecommendationCourseDto> getSpecificCourse(Long memberId, List<String> courseIds) {
    	...
    	// 코스에 대한 태그들 
    	Map<String, List<RecommendationCourseTagDto>> allCourseTagsMap = getAllCourseTagsMap(courseIds);
...
//		System.out.println(inputMap.get("courseName"));
